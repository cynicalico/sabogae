#ifndef SABOGAE_DS_PRIO_LIST_H
#define SABOGAE_DS_PRIO_LIST_H
...
template<typename T>
void
PrioList<T>::resolve_ids_(const std::string &name, std::vector<std::string> &&deps, int &i, std::vector<int> &ds) {
    i = resolve_id_(name);
